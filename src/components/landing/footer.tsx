...
export function Footer() {
  ...
  return (
    <footer className="border-t border-border bg-background/20 backdrop-blur-md">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-4 items-center">
              <a 
                href="#" 
                className="text-text-muted hover:text-primary transition-colors p-2 rounded-lg hover:bg-background-secondary"
                aria-label="Twitter"
              >
